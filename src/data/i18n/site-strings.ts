...
export const HOME: Record<string, T> = {
  ...
  contribDesc:  { en: "Four novel contributions to the fields of media literacy, mental health education, and religious coping research.", ar: "أربع مساهمات جديدة في مجالات محو الأمية الإعلامية وتعليم الصحة النفسية وبحث التكيف الديني.", arEG: "أربع مساهمات جديدة في مجالات محو الأمية الإعلامية وتعليم الصحة النفسية وبحث التإزاي الديني." },
  ...
  f3Desc:       { en: "Scored, tagged, and tiered source registry with trust bands and evidence levels.", ar: "سجل مصادر مصنف ومعلم ومتدرج مع نطاقات ثقة ومستويات أدلة.", arEG: "سجل مصادر مصنف ومعماومتدرج مع نطاقات ثقة ومستويات أدلة." },
  ...
  // RH exercise list
  posCoping7:   { en: "7 Positive coping exercises", ar: "7 تمارين التكيف الإيجابي", arEG: "7 تمارين التإزاي الإيجابي" },
  negCoping4:   { en: "4 Negative coping scenarios", ar: "4 سيناريوهات التكيف السلبي", arEG: "4 سيناريوهات التإزاي السلبي" },
...
export const ABOUT: Record<string, T> = {
  ...
  rhObj:        { en: "Coping styles, meaning frames", ar: "أساليب التكيف، أُطر المعنى", arEG: "أساليب التإزاي، أُطر المعنى" },
  rhSkill:      { en: "Positive coping + moderation", ar: "التكيف الإيجابي + الاعتدال", arEG: "التإزاي الإيجابي + الاعتدال" },
...
export const MH_HUB: Record<string, T> = {
  ...
  literacyDesc: { en: "Learn to distinguish education from diagnosis, identify appropriate next steps, and navigate the support pathway safely.", ar: "تعلم التمييز بين التعليم والتشخيص، حدد الخطوات المناسبة التالية، وتنقل في مسار الدعم بأمان.", arEG: "تعماالتمييز بين التعليم والتشخيص، حدد الخطوات المناسبة التالية، وتنقل في مسار الدعم بأمان." },
  exercises:    { en: "exercises", ar: "تمارين", arEG: "تمارين" },
  ...
  day1Desc:     { en: "Affect labeling — the simple act of naming an emotion — has been shown to reduce its intensity. Start with the science of emotional awareness.", ar: "تسمية المشاعر — الفعل البسيط لتسمية العاطفة — ثبت أنه يقلل من شدتها. ابدأ بعلم الوعي العاطفي.", arEG: "تسمية المشاعر — الفعل البسيط لتسمية العاطفة — ثبت أنه يقلل من شدتها. ابدأ بعماالوعي العاطفي." },
  startExercise:{ en: "Start Exercise", ar: "ابدأ التمرين", arEG: "ابدأ التمرين" },
...
export const RH_HUB: Record<string, T> = {
  ...
  day1Desc:     { en: "Explore the first domain of positive religious coping — turning to a higher power as a source of comfort, guidance, and strength.", ar: "استكشف المجال الأول للتكيف الديني الإيجابي — اللجوء إلى قوة عليا كمصدر للراحة والتوجيه والقوة.", arEG: "استكشف المجال الأول للتإزاي الديني الإيجابي — اللجوء إلى قوة عليا كمصدر للراحة والتوجيه والقوة." },
  startExercise:{ en: "Start Exercise", ar: "ابدأ التمرين", arEG: "ابدأ التمرين" },
};
...
export const GUIDE: Record<string, T> = {
  ...
  subtitle: { en: "How to use the platform, understand our research logic, and see why this project is different.", ar: "كيفية استخدام المنصة، فهم منطق بحثنا، ومعرفة سبب اختلاف هذا المشروع.", arEG: "إزايية استخدام المنصة، فهم منطق بحثنا، ومعرفة سبب اختلاف ده المشروع." },
  ...
  howToUse: { en: "How to Use the Website Fully", ar: "كيفية استخدام الموقع بالكامل", arEG: "إزايية استخدام الموقع بالكامل" },
  ...
  step3Desc: { en: "Navigate the three engines: DeepReal for verification, Mental Health for concepts, and Religion Hub for positive coping.", ar: "تصفح المحركات الثلاثة: ديب ريل للتحقق من المعلومات، الصحة النفسية للمفاهيم، والمحور الديني للتكيف الإيجابي.", arEG: "تصفح المحركات الثلاثة: ديب ريل للتحقق من المعلومات، الصحة النفسية للمفاهيم، والمحور الديني للتإزاي الإيجابي." },
  ...
  phil3Desc: { en: "Guiding the user away from toxic framing towards positive religious coping (Brief RCOPE).", ar: "توجيه المستخدم بعيدًا عن التأطير السام نحو التكيف الديني الإيجابي (Brief RCOPE).", arEG: "توجيه المستخدم بعيدًا عن التأطير السام نحو التإزاي الديني الإيجابي (Brief RCOPE)." },
