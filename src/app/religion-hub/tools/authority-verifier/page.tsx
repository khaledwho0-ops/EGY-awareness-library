'use client';
/* ═══════════════════════════════════════════════════════════════
 * /religion-hub/tools/authority-verifier — Coming Soon
 * ═══════════════════════════════════════════════════════════════ */
    ...
    <div className="rtool-soon-page" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="rtool-soon-content">
        ...
        <h1 className="rtool-soon-title">
          {t({ en: 'Religious Authority Verifier', ar: 'مُتحقق السلطة الدينية' })}
        </h1>
        <p className="rtool-soon-desc">
          {t({
            en: 'Verify the credentials and scholarly consensus of religious authorities. Check if a speaker is recognized by established institutions and peer scholars.',
            ar: 'تحقق من مؤهلات وإجماع العلماء الدينيين. تحقق مما إذا كان المتحدث معترفاً به من المؤسسات الراسخة وأقرانه من العلماء.',
          })}
        </p>
