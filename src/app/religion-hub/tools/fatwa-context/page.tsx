'use client';
/* ═══════════════════════════════════════════════════════════════
 * /religion-hub/tools/fatwa-context — Coming Soon
 * ═══════════════════════════════════════════════════════════════ */
    ...
    <div className="rtool-soon-page" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="rtool-soon-content">
        ...
        <h1 className="rtool-soon-title">
          {t({ en: 'Fatwa Context Analyzer', ar: 'محلل سياق الفتوى' })}
        </h1>
        <p className="rtool-soon-desc">
          {t({
            en: 'Analyze fatwas in their proper scholarly and historical context. Understand the conditions, school of thought, and time period behind each ruling.',
            ar: 'حلل الفتاوى في سياقها العلمي والتاريخي الصحيح. افهم الشروط والمذهب والحقبة الزمنية وراء كل حكم.',
          })}
        </p>
