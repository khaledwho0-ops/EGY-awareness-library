'use client';
/* ═══════════════════════════════════════════════════════════════
 * /religion-hub/tools/sectarian-detector — Coming Soon
 * ═══════════════════════════════════════════════════════════════ */
  ...
  return (
    <div className="rtool-soon-page" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="rtool-soon-content">
        <div className="rtool-soon-icon">🛡️</div>
        <h1 className="rtool-soon-title">
          {t({ en: 'Sectarian Claim Detector', ar: 'كاشف الادعاءات الطائفية' })}
        </h1>
        <p className="rtool-soon-desc">
          {t({
            en: 'Identify claims designed to divide Muslims along sectarian lines. Detects loaded language, historical distortions, and manufactured outrage.',
            ar: 'حدد الادعاءات المصممة لتقسيم المسلمين على أسس طائفية. يكشف اللغة المحملة والتشوهات التاريخية والغضب المُصنَّع.',
          })}
        </p>
